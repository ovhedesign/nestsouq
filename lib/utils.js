export const ACCEPTED = ["image/jpeg", "image/png", "image/gif", "image/bmp", "image/tiff", "image/svg+xml", "image/webp"];
export const isRaster = (type) => ["image/jpeg", "image/png", "image/gif", "image/bmp", "image/tiff"].includes(type);
